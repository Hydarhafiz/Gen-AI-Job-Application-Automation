    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link to="/login" className="flex flex-col items-center justify-center p-6 border border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
          ...
          <Link to="/profile" className="flex flex-col items-center justify-center p-6 border border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
